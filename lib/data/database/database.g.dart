...
class $WinsCompletionTable extends WinsCompletion
    with TableInfo<$WinsCompletionTable, WinsCompletionData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $WinsCompletionTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'wins_completion';
  @override
  VerificationContext validateIntegrity(
    Insertable<WinsCompletionData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  WinsCompletionData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return WinsCompletionData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  $WinsCompletionTable createAlias(String alias) {
    return $WinsCompletionTable(attachedDatabase, alias);
  }
}

class WinsCompletionData extends DataClass
    implements Insertable<WinsCompletionData> {
  final int id;
  final int habitId;
  final DateTime completedAt;
  const WinsCompletionData({
    required this.id,
  ...
  WinsCompletionCompanion toCompanion(bool nullToAbsent) {
    return WinsCompletionCompanion(
      id: Value(id),
  ...
  factory WinsCompletionData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  WinsCompletionData copyWith({int? id, int? habitId, DateTime? completedAt}) =>
      WinsCompletionData(
        id: id ?? this.id,
        habitId: habitId ?? this.habitId,
        completedAt: completedAt ?? this.completedAt,
      );
  WinsCompletionData copyWithCompanion(WinsCompletionCompanion data) {
    return WinsCompletionData(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('WinsCompletionData(')
          ..write('id: $id, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is WinsCompletionData &&
          other.id == this.id &&
          other.habitId == this.habitId &&
          other.completedAt == this.completedAt);
}

class WinsCompletionCompanion extends UpdateCompanion<WinsCompletionData> {
  final Value<int> id;
  final Value<int> habitId;
  final Value<DateTime> completedAt;
  const WinsCompletionCompanion({
    this.id = const Value.absent(),
  ...
  WinsCompletionCompanion.insert({
    ...
    required DateTime completedAt,
       ...
       completedAt = Value(completedAt);
  static Insertable<WinsCompletionData> custom({
    Expression<int>? id,
  ...
  WinsCompletionCompanion copyWith({
    Value<int>? id,
    Value<int>? habitId,
  ...
  @override
  String toString() {
    return (StringBuffer('WinsCompletionCompanion(')
          ..write('id: $id, ')
          ..write('habitId: $habitId, ')
          ..write('completedAt: $completedAt')
          ..write(')'))
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $WinsCompletionTable winsCompletion = $WinsCompletionTable(this);
  @override
  Iterable<TableInfo<Table, Object?>> get allTables =>
      allSchemaEntities.whereType<TableInfo<Table, Object?>>();
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [wins, winsCompletion];
}
...
typedef $$WinsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$WinsCompletionTableCreateCompanionBuilder =
    WinsCompletionCompanion Function({
      Value<int> id,
      required int habitId,
      required DateTime completedAt,
    });
typedef $$WinsCompletionTableUpdateCompanionBuilder =
    WinsCompletionCompanion Function({
      Value<int> id,
      Value<int> habitId,
      Value<DateTime> completedAt,
...
class $$WinsCompletionTableFilterComposer
    extends Composer<_$AppDatabase, $WinsCompletionTable> {
  $$WinsCompletionTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$WinsCompletionTableOrderingComposer
    extends Composer<_$AppDatabase, $WinsCompletionTable> {
  $$WinsCompletionTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$WinsCompletionTableAnnotationComposer
    extends Composer<_$AppDatabase, $WinsCompletionTable> {
  $$WinsCompletionTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$WinsCompletionTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $WinsCompletionTable,
          ...
          $$WinsCompletionTableOrderingComposer,
          $$WinsCompletionTableAnnotationComposer,
          $$WinsCompletionTableCreateCompanionBuilder,
          $$WinsCompletionTableUpdateCompanionBuilder,
          (
            WinsCompletionData,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$WinsCompletionTableTableManager(
    _$AppDatabase db,
    $WinsCompletionTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$WinsCompletionTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$WinsCompletionTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$WinsCompletionTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
...
typedef $$WinsCompletionTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $WinsCompletionTable,
      WinsCompletionData,
      ...
      (
        WinsCompletionData,
        BaseReferences<_$AppDatabase, $WinsCompletionTable, WinsCompletionData>,
      ),
      WinsCompletionData,
      PrefetchHooks Function()
    >;
...
class $AppDatabaseManager {
  ...
  $$WinsCompletionTableTableManager get winsCompletion =>
      $$WinsCompletionTableTableManager(_db, _db.winsCompletion);
}
